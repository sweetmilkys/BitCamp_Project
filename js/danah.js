...
danah.st = (() => {
    ...
    let ui = d => {
                ...
                src: danah.c.form({ c: 'd_form_fields', i: 'upload_post_form', et: 'multipart/form-data' })
                    .append(
                        ...
                        .append(
                            ...
                            .attr({
                                src: d.f !== 'e' ? '' : $i + '/danah/post/' + d.j.lastUpdate.replace(/-/gi, '/') + "/" + d.j.image
                            }),
                        ...
                        .val(d.f !== 'e' ? '' : d.j.roomSize)
                        .append(
                            danah.c.option({ v: '', t: '평수 선택(필수)' }),
                            danah.c.option({ v: '10평 미만', t: '10평 미만' }),
                            ...
                            .append(
                                ...
                                .keydown(function(a) {
                                    if (a.keyCode == 13) {
                                        ...
                                        if ($(this).text() === '') {
                                            $.toast($('<h3/>')
                                                .text('태그를 입력해주세요.'), { type: 'danger', duration: 2000 }
                                            );
                                        } else {
                        ...
                        .click(a => {
                            ...
                            if (!$('#d_upload_panel').hasClass('change') && d.f === 'w') {
                                danah.c.div({ c: 'alert alert-danger' })
                                    .attr({ role: 'alert' })
                                    .text('사진을 업로드해주세요.')
                                    .appendTo($('#d_progress'))
                                    .click(function() {
                                ...
                                $.ajax({
                                    ...
                                    data: JSON.stringify({
                                        ...
                                        keyword: j,
                                        image: ((d.f === 'e' && $('#d_upload_panel').hasClass('change')) || d.f === 'w') ?
                                            '' : d.j.image,
                                        lastUpdate: ((d.f === 'e' && $('#d_upload_panel').hasClass('change')) || d.f === 'w') ?
                                            '' : d.j.lastUpdate,
                    ...
                    .keydown(a => {
                        a.keyCode == 8 ? $('.d_keywords.active').remove() : '';
                    })
            },
            midClick: true,
            overflowY: 'auto',
        ...
        $('.mfp-close')
            .attr({ style: 'width: 30px; height: 30px; color: black; font-size: 25px; line-height: 30px;' })
            .appendTo(
                $('#upload_post_form')
            )
            .click(n => {
...
danah.s = (() => {
                ...
                .append(
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                danah.c.span({ c: 'd_category_item', ht: j.roomSize }),
                                danah.c.span({ c: 'd_category_item', ht: j.roomType })),
                            $('<time/>').text(j.regiDate.replace(/-/gi, '.'))
                        ),
                        ...
                        .append(
                            ...
                            .append(
                                danah.c.div({ c: 'd_footer_stats_item' })
                                .append(
                                    danah.c.span({ i: 'd_footer_viewCnt' })
                                    .append(
                                        '조회',
                                        j.viewCnt)
                                ),
                                danah.c.div({ c: 'd_footer_stats_item' })
                                .append(
                                    danah.c.span({ i: 'd_footer_commentCnt' })
                                    .append(
                                        '댓글',
                                        j.commentCnt)
                                ),
                                danah.c.div({ c: 'd_footer_stats_item' })
                                .append(
                                    danah.c.span({ i: 'd_footer_shareCnt' })
                                    .append(
                                        '공유',
                                        j.shareCnt)
                                )
                            ...
                            .append(
                                ...
                                .append(
                                    ...
                                    .append(
                                        ...
                                        .append(
                                            danah.c.img({
                                                sr: $i + ((j.profile === '' || j.profile === undefined) ?
                                                    '/danah/user_profile.jpeg' :
                                                    '/hyeri/profile/' + j.profile)
                                            })
                                        )
                                    ),
                                    danah.c.div({})
                                    .append(
                                        ...
                                        .append(
                                            $('<strong/>')
                                            .addClass('d_writer_profile_name')
                                            .text(j.nickname)))
                                )
                            ),
                            danah.c.hr({ c: 'd_section_divider' })
                        ...
                        .attr({ id: 'd_comment_feed' })
                        .append(
                            danah.c.h1({ c: 'd_comment_feed_header' })
                            .append(
                                '댓글',
                                '&nbsp;',
                                danah.c.span({ c: 'd_comment_feed_header_count', i: 'd_comment_feed_header_count', t: j.commentCnt })
                                .addClass(j.commentCnt == 0 ? 'zero' : '')),
                            ...
                            .append(
                                ...
                                .click(n => {
                                    $.toast($('<h3/>')
                                        .text('로그인이 필요한 서비스 입니다.'), { duration: 2000 });
                                    $('#login_btn')
                                        .trigger('click');
                                }),
                                ...
                                .append(
                                    danah.c.img({
                                        sr: $i + ($.cookie('userid') == undefined ?
                                            '/danah/comment_profile.jpeg' :
                                            $.cookie('profile') === 'null' ?
                                            '/danah/user_profile.jpeg' :
                                            ('/hyeri/profile/' + $.cookie('profile')))
                                    })
                                ),
                                ...
                                .append(
                                    ...
                                    .append(
                                        ...
                                        .attr({ id: 'd_comment', placeholder: '의견을 남겨 보세요.', style: 'height: 38px;' })
                                        .keydown(function(n) {
                                            if (n.keyCode == 13) $('.d_comment_feed_form_submit').trigger('click');
                                        })
                                    ),
                    ...
                    .append(
                        danah.c.div({ c: 'd_sticky_container d_sidebar_sticky' })
                        .attr({ 'data-enabled': 'false', 'data-direction': 'top', 'data-offset': '0', style: 'position: sticky; top: 80px;' })
                        .append(
                                        ...
                                        .append(
                                            ...
                                            .append(
                                                ...
                                                .click(function() {
                                                    if ($.cookie('userid') == undefined) {
                                                        $.toast($('<h3/>').text('로그인이 필요한 서비스 입니다.'), { duration: 2000 });
                                                        ...
                                                        $.getJSON($ctx + '/likes/' + $.cookie('userid') + '/' + j.seq, h => {
                                                            $(this)
                                                                ...
                                                                .append(
                                                                    danah.c.span({
                                                                        c: 'd_icon_common_action',
                                                                        s: h.check == 0 ?
                                                                            'vertical-align: middle; margin-right: 8px; background-position: -240px -280px; width: 24px; height: 24px;' : 'vertical-align: middle; margin-right: 8px; background-position: -40px -280px; width: 24px; height: 24px;'
                                                                    }),
                                                                    h.likeCnt
                                                                );
                                                            $('#d_floating_bar_like_btn')
                                                                ...
                                                                .append(
                                                                    danah.c.span({
                                                                        c: 'd_icon_common_action',
                                                                        s: h.check == 0 ?
                                                                            'vertical-align: middle; margin-right: 6px; background-position: 0px -280px; width: 24px; height: 24px;' : 'vertical-align: middle; margin-right: 8px; background-position: -40px -280px; width: 24px; height: 24px;'
                                                                    }),
                                                                    h.likeCnt
                                                                );
                                                        });
                                            ...
                                            .append(
                                                ...
                                                .append(
                                                    ...
                                                    .text('삭제')
                                                    .click(n => {
                                                        r({ j: j.seq, e: j.lastUpdate, o: j.image });
                                                    })
                                                )
                                            )
                                            .click(n => {
                                                let h = $('.d_mine');
                                                h.children(':last').hasClass('d_dismiss') ?
                                                    h.children(':last').removeClass('d_dismiss') :
                                                    h.children(':last').addClass('d_dismiss');
                                            }) :
                                            ""
                                        ),
                                        ...
                                        .append(
                                            ...
                                            .append(
                                                ...
                                                .append(danah.c.a({})
                                                    .append(
                                                        $('<strong/>')
                                                        .addClass('d_writer_profile_name').text(j.nickname))
                                                )
                                            )
                                        ),
                                        danah.c.section({ c: 'd_sidebar_others' })
                                        .append(t(k))
                                    ),
                                    danah.c.section({ c: 'd_sidebar_share' })
                                    .append(
                                        danah.c.div({ c: 'd_share_post' })
                                        .append(danah.u.s(j.seq)))
                                )
                            )
                        )
                    ),
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .click(n => {
                                $('html, body')
                                    .animate({ scrollTop: $('#d_comment_feed').offset().top }, 500);
                            }),
                            ...
                            .click(n => {
                                p.find('.d_share_tooltip_tooltip')
                                    .attr({
                                        'style': p.find('.d_share_tooltip_tooltip')
                                            .attr('style') === 'right: 0px; bottom: 100%; transition: opacity 0.3s ease 0s, transform 0.3s ease 0s, visibility 0s ease 0.3s; opacity: 0; transform: translateY(-16px); visibility: hidden;' ?
                            ...
                            .append(
                                ...
                                .append(
                                    danah.c.span({ c: 'd_icon_common_action', s: 'background-position: -200px 0px; width: 28px; height: 28px;' })
                                ),
                                ...
                                .append(
                                    ...
                                    .append(
                                        danah.c.span({ c: 'd_icon d_icon_sns_square_facebook' })
                                    )
                                    .click(n => {
                                        p.find('.d_share_tooltip_tooltip')
                                            .attr({
                                    ...
                                    .append(
                                        danah.c.span({ c: 'd_icon d_icon_sns_square_kakao_story' })
                                    )
                                    .click(n => {
                                        p.find('.d_share_tooltip_tooltip')
                                            .attr({
                                    ...
                                    danah.c.a({ c: 'd_share_tooltip_btn_share', tg: '_blank', r: 'noopener noreferrer' })
                                    .append(
                                        danah.c.span({ c: 'd_icon d_icon_sns_square_naver' }))
                                    .click(n => {
                                        p.find('.d_share_tooltip_tooltip')
                                            .attr({
                                                'style': p.find('.d_share_tooltip_tooltip')
            ...
            danah.c.a({})
                .append(
                    ...
                    .append(
                        ...
                        .click(a => {
                            (this.itemSeq == undefined) ?
                            '' :
                            $.getScript($js + '/jieun.js', () => {
    ...
    let ip = d => {
        $.each(d, function() {
            this.itemSeq == undefined ?
                ...
                .append(danah.c.div({ c: 'd_used_product_item' })
                    .append(danah.c.img({ sr: $i + '/jun/' + this.category + '/' + this.image + '.jpg' }))
                    .click(() => {
                        $.getScript($js + '/jieun.js', () => {
                            jieun.detail({ seq: this.itemSeq, category: this.category, photo: this.image });
                        });
                ...
                .append(
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                danah.c.img({
                                    c: 'd_comment_feed_item_content_author_image',
                                    sr: $i + ((this.profile === '' || this.profile === undefined || this.profile === 'null') ?
                                        '/danah/comment_profile.jpeg' :
                                        '/hyeri/profile/' + this.profile)
                                }),
                            ...
                            .click(a => {
                                if (confirm('삭제하시겠습니까?')) {
                                    $.getJSON($ctx + '/comments/delete/' + this.postSeq + '/' + this.seq, n => {
                                        $.toast($('<h3/>').text('삭제하였습니다.'), { type: 'success', duration: 2000 });
                                        $('#d_comment_feed_list').remove();
                                        $('#d_list_paginator').remove();
                                        $('#d_comment_feed')
                                            .append(c(n.comment), cp({ j: n.seq, e: n.page }));
                                        $('#d_comment_feed_header_count')
                                            .text(n.page.totalRecode);
                                        $('#d_btn_commentCnt')
                                            .html('')
                                            .append(
                                                danah.c.span({ c: 'd_icon_common_action', s: 'vertical-align: middle; margin-right: 6px; background-position: -160px -280px; width: 24px; height: 24px;' }),
    ...
    let cp = d => {
        ...
        for (let i = e.startPage - 1; i <= e.endPage + 1; i++) {
            danah.c.li({})
                .attr({
                    value: e.startPage - 1 == i ?
                        (i + 1) : i,
                    style: (e.startPage - 1 == i) ?
                        'margin-left: -40px;border: 1px solid #DCDCDC;border-radius: 5px;display: inline-block;width: 26px;height: 26px;position: absolute;text-align: center;' : (e.endPage + 1 == i) ?
                        'margin-left: 20px;border: 1px solid #DCDCDC;border-radius: 5px;display: inline-block;width: 26px;height: 26px;position: absolute;text-align: center;' : ''
                })
                .append(
                    danah.c.button({
                        c: (e.startPage - 1 == i) ?
                            'd_list_paginator_prev' : (e.endPage + 1 == i) ?
                            'd_list_paginator_next' : 'd_list_paginator_page d_sm'
                    })
                    .addClass(e.pageNo == i ? 'selected' : '')
                    .append((e.startPage - 1 == i) ?
                ...
                .appendTo(
                    ((e.existPrev === false && (e.startPage - 1 == i)) || ((e.existNext === false) && (e.endPage + 1 == i))) ?
                    '' :
                    p
                )
                .click(function() {
                    let o = $(this).children().hasClass('d_list_paginator_next') ?
                        (+e.pageNo + 1) :
                        $(this).children().hasClass('d_list_paginator_prev') ?
                        (+e.pageNo - 1) :
                        $(this).text();
    ...
    let r = d => {
        if (confirm('삭제하시겠습니까?')) {
            $.toast($('<h3/>').text('게시물을 삭제하였습니다.'), { type: 'success', duration: 2000 });
            $.ajax({
    ...
    let lc = d => {
        $.cookie('userid') == undefined ?
            "" :
            $.getJSON($ctx + '/likes/' + $.cookie('userid'), a => {
                $.each(a, function() {
                    if (d === this.seq && this.check == 1) {
                        $('#d_floating_bar_like_btn')
                            .children(':first')
                            .attr({ style: 'vertical-align: middle; margin-right: 8px; background-position: -40px -280px; width: 24px; height: 24px;' });
                        $('#d_sidebar_like_btn')
                            .children(':first')
                            .attr({ style: 'vertical-align: middle; margin-right: 8px; background-position: -40px -280px; width: 24px; height: 24px;' });
                    }
            ...
            danah.c.div({ c: 'd_sidebar_others_thumbnail' })
                .append(
                    ...
                    .append(
                        danah.c.a({})
                        .append(
                            danah.c.img({ sr: $i + '/danah/post/' + this.lastUpdate.replace(/-/gi, '/') + "/" + this.image })
                        )
                    )
                )
                .appendTo(p)
...
danah.lt = (() => {
    ...
    let s = d => {
        let p = danah.c.p({ c: 'd_post_search' }),
            j = 1;
        d = d || ' ';
        $.getJSON($ctx + '/posts/hashTagSearch/' + d + '/1', a => {
            $ctt
                .html(danah.c.div({ c: 'd_container', i: 'd_post_search' })
                    .append(
                        p.html(["'", d, "' 에 대한 검색 결과        "])
                        .append(
                            danah.c.span({})
                            .append(a.list.length, ' 개')),
                        danah.c.div({ c: 'd_row', i: 'd_row', s: 'margin-top:20px' })
                    )
                );
            $.cookie('userid') == undefined ?
            ...
            $(window).off().scroll(function() {
                if (a.page > j && $('#d_post_search').length > 0 && $(this).scrollTop() >= $(document).height() - $(this).height()) {
                    $('#d_row')
                        .append(
                            $.getJSON($ctx + '/posts/hashTagSearch/' + d + '/' + ++j, n => {
                                $.cookie('userid') == undefined ?
                                    ui({ j: n }) :
                                    ll(n);
                                $('figcaption').remove();
    ...
    // 게시글 필터
    let f = d => {
        let p = danah.c.div({ c: 'd_filter_wrap', i: 'd_filter_wrap' });
        p.append(
            ...
            danah.c.li({ c: 'd_filter_item' })
                .append(
                    ...
                    .append(
                        ...
                        .append(
                            danah.c.span({ c: 'd_filter_item_btn_search_icon', s: 'margin-left:7px;transform-origin:center 7px;transition:transform .2s linear;transform:rotate(0deg);background-position-x:-40px;background-position-y:-0px;width:12px;height:12px' })
                        ),
                ...
                .click(d => {
                    ...
                    if (j.eq(i).hasClass('d_filter_item_active')) {
                        ...
                        $.each((i == 0 ? ['최신순', '인기순', '베스트'] :
                            ...
                            i == 2 ? ['모든평수', '10평 미만', '10평대', '20평대', '30평대', '40평대 이상'] : ['모두', '정보있는사진만']), function() {
                            danah.c.li({ c: 'd_filter_item' })
                                .addClass(
                                    j.eq(i).find('.d_filter_item_btn_search_val').text() === this ?
                                    'd_filter_item_active' :
                                    ''
                                )
                                ...
                                .click(function() {
                                    ...
                                    e.attr('style', 'margin-left:7px;transform-origin:center 7px;transition:transform .2s linear;transform:rotate(0deg);background-position-x:-40px;background-position-y:-0px;width:12px;height:12px');
                                    o.addClass('d_filter_hidden');
                                    $.each($('.d_filter_item_btn_search_val'), function() {
                                        u.push($(this).text());
                                    });
                                    $.getJSON($ctx + '/posts/search/' + u + '/1', a => {
                                        if (a.list.length != 0 && a != null) {
                                            ...
                                            $.cookie('userid') == undefined ?
                                                ...
                                                ll(a);
                                            $(window).off().scroll(function() {
                                                if (a.page > g && $('#d_filter_wrap').length > 0 && $(this).scrollTop() >= $(document).height() - $(this).height()) {
                                                    $('#d_row')
                                                        .append(
                                                            $.getJSON($ctx + '/posts/search/' + u + '/' + ++g, n => {
                                                                $.cookie('userid') == undefined ?
                                                                    ui({ j: n }) :
                                                                    ll(n);
                                                            })
            ...
            danah.c.article({ c: 'd_col_12  d_col_md_4 d_col_lg_3 d_post', hc: 'd_post_writer' })
                .append(
                    ...
                    .append(
                        ...
                        .append(
                            danah.c.img({
                                sr: $i + ((this.profile === '' || this.profile === undefined) ?
                                    '/danah/user_profile.jpeg' :
                                    '/hyeri/profile/' + this.profile),
                                a: this.nickname + '의 프로필 사진'
                            })
                        ),
                        danah.c.p({
                            c: 'd_post_writer_about',
                            ht: danah.c.a({ ht: $('<strong/>').text(this.nickname) })
                        })
                    ),
                    $('<figure/>')
                    .append(
                        ...
                        .append(
                            danah.c.img({
                                c: (this.imageTagCnt == 0) ?
                                    'd_vertical' : 'd_horizon',
                                sr: $i + '/danah/post/' + this.lastUpdate.replace(/-/gi, '/') + '/' + this.image
                            }),
                            this.imageTagCnt == 0 ?
                            '' :
                            danah.c.span({ c: 'd_post_img_icon d_post_img_info', s: 'background-position: 0px 0px; width: 14px; height: 14px;' }),
                            danah.c.span({ c: 'd_post_img_view' })
                            .append(
                                '조회수 ',
                                this.viewCnt
                            )
                        ...
                        .append(
                            ...
                            .click(function(n) {
                                ...
                                if ($.cookie('userid') == undefined) {
                                    ...
                                    $.getJSON($ctx + '/likes/' + $.cookie('userid') + '/' + j.list[i].seq, h => {
                                        $(this)
                                            .html('')
                                            .append(
                                                danah.c.span({
                                                    c: 'd_post_action_icon',
                                                    s: h.check == 0 ?
                                                        'background-position: -240px -280px; width: 24px; height: 24px;' : 'background-position: -40px -280px; width: 24px; height: 24px;'
                                                }),
                                                h.likeCnt);
                                    });
                                }
...
danah.t = (() => {
    ...
    let t = d => {
        ...
        p.append(
            ...
            .append(
                ...
                .append(
                    ...
                    .append(
                        danah.c.img({ sr: $i + '/danah/post/' + d.j.lastUpdate.replace(/-/gi, '/') + "/" + d.j.image, a: 'None' })
                    )
                    .click(function(a) {
                        if (c()) {
                            ...
                            m({
                                    j: parseInt(a.pageX - $('#d_image_panel').offset().left - 15),
                                    e: parseInt(a.pageY - $('#d_image_panel').offset().top) - 15,
                                    o: j
                                })
                                .appendTo($('#d_image_panel'));
                            $('.ui-autocomplete')
                                .attr({ style: 'top: auto;' })
                                .appendTo($('.d_user_field'))
                                .click(function(n) {
                                    n.stopPropagation();
                                });
                            j++;
        ...
        $.each(d.e, function() {
            m({
                    f: 'e',
                    j: this.position.split(',')[0],
                    e: this.position.split(',')[1],
                    o: j,
                    g: this.itemTitle,
                    u: this.itemSeq,
                    k: this.seq
    ...
    let c = d => {
        ...
        e ?
            $('.ui-autocomplete').empty() :
            $.toast($('<h3/>').text('열려진 태그에 내용을 입력해주세요.'), { type: 'danger', duration: 2000 });
        return e;
    };
    // 태그 생성하기
    let m = d => {
        let p = danah.c.div({ c: 'd_tags_form', i: 'd_tags_form_' + d.o, s: 'left:' + d.j + 'px; top:' + d.e + 'px; z-index: 1;' });
        p.addClass(d.f === 'e' ? 'd_edit' : '')
            .append(
                danah.c.div({ c: 'd_tag_icon d_gray' })
                .click(a => {
                    a.stopPropagation();
                    if (c() && ($('#d_tag_information_' + d.o)
                            .css('display') == 'none')) {
                        $('.d_tag_information')
                            .attr({ style: 'display:none' });
                        $('#d_tag_information_' + d.o)
                ...
                .append(
                    ...
                    .append(
                        ...
                        (d.f === 'e') ?
                        danah.c.input({ c: 'd_postion_q', ty: 'hidden', n: 'd_tags_position_q', i: 'd_tags_position_q', v: d.k }) :
                        ''
                    ),
                    ...
                    .append(
                        ...
                        .attr({ placeholder: '브랜드/구입처/제품명/후기 등을 입력 해주세요.', id: 'd_tags_description_' + d.o, name: 'd_tags_description' })
                        .val(d.g)
                    ...
                    .append(
                        ...
                        .click(a => {
                            ...
                            if (c()) {
                                $.each(it, (i, v) => {
                                    if ($('#d_tags_description_' + d.o).val() === it[i]) $('#d_tags_position_s_' + d.o).val(is[i]);
                                });
                                $('.d_tag_information').hide();
                            }
                        }),
                        ...
                        .click(a => {
                            ...
                            if ($('#d_tags_description_' + d.o).val() == '' || c()) {
                                if (p.hasClass('d_edit')) {
                                    danah.c.input({ c: 'd_destroy_item', ty: 'hidden', v: d.k })
                                        .appendTo($('#d_destroy_tags'));
                                }
...
danah.u = {
    ...
    sb: d => {
        $.getJSON($.context() + '/hashTags', a => {
            ...
            $('.ui-autocomplete')
                .attr({ style: 'flex-direction: row; position: absolute; z-index: 2000; width: 266px; max-height: 450px; left: ' + ($('#search_btn').offset().left - $(window).scrollLeft()) + 'px; top:64px' })
                .appendTo($('.navigation-search'))
                .click(function(n) {
                    n.preventDefault();
                    danah.lt.s($('.navigation-search__box__input').val());
                    $(this).remove();
                });
        });
    },
    ...
    tb: d => {
        ...
        $(window).scroll(() => {
            $(this).scrollTop() > 200 ?
                $('.d_top_btn').fadeIn('2000') :
                $('.d_top_btn').fadeOut('500');
        });
    },
    // 공유하기 버튼
    s: d => {
        ...
        $.each([
            'background-position: -80px -40px; width: 48px; height: 48px;',
            'background-position: -160px -40px; width: 48px; height: 48px;',
            'background-position: -240px -40px; width: 48px; height: 48px;',
            'background-position: -320px -40px; width: 48px; height: 48px;'
        ], function(i) {
            danah.c.div({})
                .append(
                    (i < 2) ?
                    danah.c.a({ c: 'd_share_post_btn', tg: '_blank', r: 'noopener noreferrer' })
                    .append(danah.c.span({ c: 'd_icon_page_post', s: this })) :
                ...
                .click(a => {
                    switch (i) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            p.children(':last').hasClass('d_invisible') ?
                                p.children(':last').removeClass('d_invisible') :
            ...
            danah.c.div({ c: 'd_share_post_url d_tooltip d_invisible' })
                .append(
                    danah.c.p({ t: $.u(), i: 'd_shre_post_url' }),
                    danah.c.button({}).text('복사')
                    .click(a => {
                        p.children(':last').addClass('d_invisible');
                        let temp = $('<input/>');
                        temp.appendTo($('body')).val($('#d_shre_post_url').text()).select();
                        document.execCommand('copy');
                        temp.remove();
                        $.getJSON($.context() + '/share/' + d, n => {
                            $.toast($('<h3/>').text('URL을 클립보드에 복사하였습니다.'), { type: 'success', duration: 2000 });
                            $('#d_footer_shareCnt')
                                .html('')
                                .append('공유', n);
                            $('#d_btn_shareCnt')
...
$.prototype.danahValChk = d => {
    ...
    j ? '' : $.toast($('<h3/>').text('필수 입력값이 입력되지 않았습니다.'), { type: 'danger', duration: 2000 });
    return j;
};
/* ************************************
-- 확장자 확인
...
$.prototype.danahExtChk = d => {
    ...
    j ? '' : $.toast($('<h3/>').text('gif,png,jpg,jpeg 파일만 업로드 할 수 있습니다.'), { type: 'danger', duration: 2000 });
    return j;
}
/* ************************************
-- 카카오 API
...
function DanahS(d) {
    Kakao.cleanup();
    Kakao.init('0596432e8bfec26fce83c420ef8fcff1');
